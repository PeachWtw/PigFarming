...
class BreedImprovement(models.Model):
    ...
    def __unicode__(self):
        return "'title':%s, 'abstract':%s, 'content':%s, 'publish_time':%s, 'click_times':%s, 'src_img':%s, 'type':%s" % (self.title,self.abstract,self.content,self.publish_time,self.click_times,self.src_img,self.type)
